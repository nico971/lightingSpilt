...
# --- QMainWindow avec menubar ---
class ColorCalibrationWindow(QMainWindow):
    def __init__(self, pdf_path="test.pdf", page_number=0):
        super().__init__()
        self.setWindowTitle("Calibration HSV PDF")
        self.resize(950, 700)
        ...
        # --- Central Widget ---
        self.dialog = ColorCalibrationDialog(pdf_path=pdf_path, page_number=page_number)
...
if __name__ == "__main__":
    ...
    window = ColorCalibrationWindow(pdf_path="test.pdf", page_number=0)
    window.show()
    sys.exit(app.exec_())
